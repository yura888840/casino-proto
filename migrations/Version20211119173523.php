 ...
 */
final class Version20211119173523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE casino_rating_casino');
        ...
        $this->addSql('DROP INDEX IDX_6FB185535BA4E14B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ratings_rate AS SELECT id, casito_rate_id, casino_id, rate FROM ratings_rate');
        ...
        $this->addSql('INSERT INTO ratings_rate (id, casino_rate_id, casino_id, rate) SELECT id, casito_rate_id, casino_id, rate FROM __temp__ratings_rate');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE casino_rating_casino (casino_rating_id INTEGER NOT NULL, casino_id INTEGER NOT NULL, PRIMARY KEY(casino_rating_id, casino_id))');
        $this->addSql('CREATE INDEX IDX_DFC84F63B19AAF95 ON casino_rating_casino (casino_id)');
        $this->addSql('CREATE INDEX IDX_DFC84F63BEF45146 ON casino_rating_casino (casino_rating_id)');
        ...
        $this->addSql('DROP TABLE ratings_rate');
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_id INTEGER NOT NULL, casito_rate_id INTEGER NOT NULL, rate INTEGER NOT NULL)');
        $this->addSql('INSERT INTO ratings_rate (id, casino_id, casito_rate_id, rate) SELECT id, casino_id, casino_rate_id, rate FROM __temp__ratings_rate');
        $this->addSql('DROP TABLE __temp__ratings_rate');
        $this->addSql('CREATE INDEX IDX_6FB18553B19AAF95 ON ratings_rate (casino_id)');
        $this->addSql('CREATE INDEX IDX_6FB185535BA4E14B ON ratings_rate (casito_rate_id)');
    }
}
