 ...
 */
final class Version20211120160503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5FFE94F6F229BAA2');
        $this->addSql('DROP INDEX IDX_5FFE94F6BEF45146');
        $this->addSql('CREATE TEMPORARY TABLE __temp__casino_rating_ratings_rate AS SELECT casino_rating_id, ratings_rate_id FROM casino_rating_ratings_rate');
        $this->addSql('DROP TABLE casino_rating_ratings_rate');
        $this->addSql('CREATE TABLE casino_rating_ratings_rate (casino_rating_id INTEGER NOT NULL, ratings_rate_id INTEGER NOT NULL, PRIMARY KEY(casino_rating_id, ratings_rate_id), CONSTRAINT FK_5FFE94F6BEF45146 FOREIGN KEY (casino_rating_id) REFERENCES casino_rating (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5FFE94F6F229BAA2 FOREIGN KEY (ratings_rate_id) REFERENCES ratings_rate (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO casino_rating_ratings_rate (casino_rating_id, ratings_rate_id) SELECT casino_rating_id, ratings_rate_id FROM __temp__casino_rating_ratings_rate');
        $this->addSql('DROP TABLE __temp__casino_rating_ratings_rate');
        $this->addSql('CREATE INDEX IDX_5FFE94F6F229BAA2 ON casino_rating_ratings_rate (ratings_rate_id)');
        $this->addSql('CREATE INDEX IDX_5FFE94F6BEF45146 ON casino_rating_ratings_rate (casino_rating_id)');
        ...
        $this->addSql('DROP INDEX IDX_6FB185536B28F06A');
        $this->addSql('DROP INDEX IDX_6FB18553B19AAF95');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ratings_rate AS SELECT id, casino_rate_id, casino_id, rate FROM ratings_rate');
        $this->addSql('DROP TABLE ratings_rate');
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_rate_id INTEGER DEFAULT NULL, casino_id INTEGER NOT NULL, rate INTEGER NOT NULL, CONSTRAINT FK_6FB18553B19AAF95 FOREIGN KEY (casino_id) REFERENCES casino (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6FB185536B28F06A FOREIGN KEY (casino_rate_id) REFERENCES casino_rating (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ratings_rate (id, casino_rate_id, casino_id, rate) SELECT id, casino_rate_id, casino_id, rate FROM __temp__ratings_rate');
        $this->addSql('DROP TABLE __temp__ratings_rate');
        $this->addSql('CREATE INDEX IDX_6FB185536B28F06A ON ratings_rate (casino_rate_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__casino_rating_ratings_rate AS SELECT casino_rating_id, ratings_rate_id FROM casino_rating_ratings_rate');
        $this->addSql('DROP TABLE casino_rating_ratings_rate');
        $this->addSql('CREATE TABLE casino_rating_ratings_rate (casino_rating_id INTEGER NOT NULL, ratings_rate_id INTEGER NOT NULL, PRIMARY KEY(casino_rating_id, ratings_rate_id))');
        $this->addSql('INSERT INTO casino_rating_ratings_rate (casino_rating_id, ratings_rate_id) SELECT casino_rating_id, ratings_rate_id FROM __temp__casino_rating_ratings_rate');
        $this->addSql('DROP TABLE __temp__casino_rating_ratings_rate');
        $this->addSql('CREATE INDEX IDX_5FFE94F6BEF45146 ON casino_rating_ratings_rate (casino_rating_id)');
        $this->addSql('CREATE INDEX IDX_5FFE94F6F229BAA2 ON casino_rating_ratings_rate (ratings_rate_id)');
        ...
        $this->addSql('DROP INDEX IDX_6FB18553B19AAF95');
        $this->addSql('DROP INDEX IDX_6FB185536B28F06A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ratings_rate AS SELECT id, casino_id, casino_rate_id, rate FROM ratings_rate');
        $this->addSql('DROP TABLE ratings_rate');
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_id INTEGER NOT NULL, casino_rate_id INTEGER NOT NULL, rate INTEGER NOT NULL)');
        $this->addSql('INSERT INTO ratings_rate (id, casino_id, casino_rate_id, rate) SELECT id, casino_id, casino_rate_id, rate FROM __temp__ratings_rate');
        $this->addSql('DROP TABLE __temp__ratings_rate');
        $this->addSql('CREATE INDEX IDX_6FB18553B19AAF95 ON ratings_rate (casino_id)');
        $this->addSql('CREATE INDEX IDX_6FB185536B28F06A ON ratings_rate (casino_rate_id)');
    }
