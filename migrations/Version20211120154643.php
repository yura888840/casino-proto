 ...
 */
final class Version20211120154643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_rate_id INTEGER NOT NULL, casino_id INTEGER NOT NULL, rate INTEGER NOT NULL, CONSTRAINT FK_6FB18553B19AAF95 FOREIGN KEY (casino_id) REFERENCES casino (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6FB185536B28F06A FOREIGN KEY (casino_rate_id) REFERENCES casino_rating (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
