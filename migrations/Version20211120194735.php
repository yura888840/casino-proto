 ...
 */
final class Version20211120194735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE casino_casino_rating');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE casino_casino_rating (casino_id INTEGER NOT NULL, casino_rating_id INTEGER NOT NULL, PRIMARY KEY(casino_id, casino_rating_id))');
        $this->addSql('CREATE INDEX IDX_17015FBFBEF45146 ON casino_casino_rating (casino_rating_id)');
        $this->addSql('CREATE INDEX IDX_17015FBFB19AAF95 ON casino_casino_rating (casino_id)');
