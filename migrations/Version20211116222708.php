 ...
 */
final class Version20211116222708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casito_rate_id INTEGER NOT NULL, casino_id INTEGER NOT NULL, rate INTEGER NOT NULL)');
