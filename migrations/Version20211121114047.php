 ...
 */
final class Version20211121114047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN title VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN description VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN keywords CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN addition CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN content1 CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN content2 CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE casino_rating ADD COLUMN active BOOLEAN DEFAULT \'1\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__casino');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_830F4797C4663E4 ON casino (page_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__casino_rating AS SELECT id, name, slug FROM casino_rating');
        $this->addSql('DROP TABLE casino_rating');
        $this->addSql('CREATE TABLE casino_rating (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name CLOB NOT NULL, slug VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO casino_rating (id, name, slug) SELECT id, name, slug FROM __temp__casino_rating');
