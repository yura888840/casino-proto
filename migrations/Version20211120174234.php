 ...
 */
final class Version20211120174234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ratings_rate AS SELECT id, casino_id, rate FROM ratings_rate');
        $this->addSql('DROP TABLE ratings_rate');
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_id INTEGER NOT NULL, casino_rating_id INTEGER , rate INTEGER NOT NULL, CONSTRAINT FK_6FB18553B19AAF95 FOREIGN KEY (casino_id) REFERENCES casino (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6FB18553BEF45146 FOREIGN KEY (casino_rating_id) REFERENCES casino_rating (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ratings_rate (id, casino_id, rate) SELECT id, casino_id, rate FROM __temp__ratings_rate');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ratings_rate AS SELECT id, casino_id, rate FROM ratings_rate');
        $this->addSql('DROP TABLE ratings_rate');
        $this->addSql('CREATE TABLE ratings_rate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, casino_id INTEGER NOT NULL, rate INTEGER NOT NULL, casino_rate_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO ratings_rate (id, casino_id, rate) SELECT id, casino_id, rate FROM __temp__ratings_rate');
        $this->addSql('DROP TABLE __temp__ratings_rate');
        $this->addSql('CREATE INDEX IDX_6FB18553B19AAF95 ON ratings_rate (casino_id)');
